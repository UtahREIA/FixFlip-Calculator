// check-phone-short-term.js
// Verifies phone access for Short Term Calculator using Airtable
...
module.exports = async (req, res) => {
  ...
  const AIRTABLE_KEY = process.env.AIRTABLE_API_KEY_SHORT_TERM;
  const AIRTABLE_ID = process.env.AIRTABLE_BASE_SHORT_TERM;
  const AIRTABLE_TABLE_NAME = process.env.AIRTABLE_TABLE_SHORT_TERM || 'Verifications';
  ...
  try {
    ...
    console.error('Short Term verification error:', err?.message, err?.response?.data);
