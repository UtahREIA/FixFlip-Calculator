...
module.exports = async (req, res) => {
  ...
  const AIRTABLE_KEY = process.env.AIRTABLE_API_KEY_RENTAL;
  const AIRTABLE_ID = process.env.AIRTABLE_BASE_ID_RENTAL;
  const AIRTABLE_TABLE_NAME = process.env.AIRTABLE_TABLE_NAME_RENTAL || 'Verifications';
  ...
  try {
    ...
    console.error('Rental verification error:', err?.message, err?.response?.data);
